...
export const owner = Owner.create({
  ownerId: "1001",
  name: "John",
  phoneNumber: "933001122",
});
export const patient1 = Patient.create(
  { ...patientData, patientId: "some-patient-id" },
  owner
);
export const patient2 = Patient.create(
  { ...patientData, patientId: "some-id" },
  owner
);
export const patient3 = Patient.create(
  { ...patientData, patientId: "some-other-id" },
  owner
);
export const patient4 = Patient.create(
  { ...patientData, patientId: "some-dummy-id" },
  owner
);
