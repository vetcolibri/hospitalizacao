...
Deno.test("DateValue", async (t) => {
	...
	await t.step(
		"Deve retornar true quando o método earlierThan for chamado com uma data posterior",
		() => {
	...
	await t.step(
		"Deve retornar false quando o método earlierThan for chamado com uma data anterior",
		() => {
	...
	await t.step(
		"Deve retornar false quando o método earlierThan for chamado com a mesma data",
		() => {
			const date1 = DateValue.fromString("2023-10-01").right;
			const date2 = DateValue.fromString("2023-10-01").right;
