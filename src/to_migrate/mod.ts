...
import { PostgresAlertRepository } from "@infra/persistence/postgres/postgres_alert_repository.ts";
import { PostgresBudgetRepository } from "@infra/persistence/postgres/postgres_budget_repository.ts";
import { PostgresHospitalizationRepository } from "@infra/persistence/postgres/postgres_hospitalization_repository.ts";
import { PostgresMeasurementService } from "@infra/persistence/postgres/postgres_measurement_service.ts";
import { PostgresOwnerRepository } from "@infra/persistence/postgres/postgres_owner_repository.ts";
import { PostgresPatientRepository } from "@infra/persistence/postgres/postgres_patient_repository.ts";
import { PostgresReportRepository } from "@infra/persistence/postgres/postgres_report_repository.ts";
import { PostgresReportService } from "@infra/persistence/postgres/postgres_report_service.ts";
import { PostgresRoundRepository } from "@infra/persistence/postgres/postgres_round_repository.ts";
import { PostgresTransationController } from "@infra/persistence/postgres/postgres_transaction_controller.ts";
