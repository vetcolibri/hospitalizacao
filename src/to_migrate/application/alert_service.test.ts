...
import { assertSpyCall, assertSpyCalls, spy } from "@deps/mock";
...
import { AlertNotifierDummy } from "../test_doubles/alert_notifier_dummy.ts";
import { PatientRepositoryStub } from "../test_doubles/patient_repository_stub.ts";
